...
public class ProblemEntity {
    ...
    @Column(name = "problem_number", nullable = false, length = 200)
    private Integer problemNumber; // 문제 번호를 나타냅니다.

    @Column(name = "title", nullable = false, length = 200)
    private String title; // 문제 제목을 나타냅니다.

    @Column(name = "problem_tag", nullable = false, length = 200)
    private String problemTag; // 문제 태그를 나타냅니다.

    @Column(name = "problem_level", nullable = false, length = 200)
    private Integer problemLevel; // 문제의 난이도를 나타냅니다.

    @Column(name = "solved_user_count", nullable = false, length = 200)
